...
// Last update Wed Jun 11 13:10:13 2014 LOEB Thomas
//

#include	<iostream>
#include	"GUI/EnnemyGUI.hh"

EnnemyGUI::EnnemyGUI() : AObject() {}

EnnemyGUI::~EnnemyGUI() {}

bool		EnnemyGUI::initialize(glm::vec3 const &pos) {
  if (_model.load("animations/ganondorf.FBX") == false)
    return (false);
...
void		EnnemyGUI::draw(gdl::AShader &shader, gdl::Clock const &clock) {
